    ...
    public partial class p : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSaldos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSaldos_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "Name", "Pin" },
                values: new object[] { 1, "Administrator", "$2b$10$.ErrTNAj4waqYMSOP2I0fOz4/ftEVNblaBzf58sDhFJl/GVFGUGK2" });
